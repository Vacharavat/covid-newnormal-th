          ...
          >
            ...
            <View style={{ flex: 0.4, justifyContent: "center" }}>
              ...
              >
                ...
                <Text>{Number(this.state.confirmedglobal).toLocaleString('en')} คน</Text>
              </Text>
            </View>
          </View>
        </View>
          ...
          >
            ...
            <View style={{ flex: 0.4, justifyContent: "center" }}>
              ...
              >
                ...
                <Text>{Number(this.state.recoveredglobal).toLocaleString('en')} คน</Text>
              </Text>
            </View>
          </View>
        </View>
          ...
          >
            ...
            <View style={{ flex: 0.4, justifyContent: "center" }}>
              ...
              >
                ...
                <Text>{Number(this.state.deathglobal).toLocaleString('en')} คน</Text>
              </Text>
            </View>
          </View>
        </View>
