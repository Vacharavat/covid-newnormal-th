          ...
          >
            ...
            <View style={{ flex: 0.4, justifyContent: "center" }}>
              ...
              >
                ...
                <Text>{Number(this.state.bangkok).toLocaleString('en')} คน</Text>
              </Text>
            </View>
          </View>
        </View>
          ...
          >
            ...
            <View style={{ flex: 0.4, justifyContent: "center" }}>
              ...
              >
                ...
                <Text>{Number(this.state.chonburi).toLocaleString('en')} คน</Text>
              </Text>
            </View>
          </View>
        </View>
          ...
          >
            ...
            <View style={{ flex: 0.4, justifyContent: "center" }}>
              ...
              >
                ...
                <Text>{Number(this.state.phuket).toLocaleString('en')} คน</Text>
              </Text>
            </View>
          </View>
        </View>
