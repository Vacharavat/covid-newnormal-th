          ...
          <ScrollView>
            ...
            <View style={styles.bigstatblock}>
              ...
              <View style={styles.statblock}>
                <Text
                  style={{ color: Color.gray, fontWeight: "bold", padding: 8 }}
                >
                  Confirmed
                </Text>
                <Text style={styles.txtstats}>{this.state.confirmed}</Text>
                <Text style={styles.subtxtstats}>
              ...
              <View style={styles.statblock}>
                <Text
                  style={{ color: Color.green, fontWeight: "bold", padding: 8 }}
                >
                  Recovered
                </Text>
            ...
            <View style={styles.symtompsblock}>
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.props.navigation.navigate("SymptompsScreenDetail")
                    }
                  >
            ...
            <View style={styles.preventionsblock}>
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.props.navigation.navigate("PreventionsScreenDetail")
                    }
                  >
                    <View style={styles.subdetail2}>
                      <View style={styles.imageblock}>
