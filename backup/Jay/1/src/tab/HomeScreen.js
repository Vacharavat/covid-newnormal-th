        ...
        {/* Top Page */}
          ...
          <View style={styles.symtompsblock}>
            ...
            <View style={{flexDirection:'row', flex:0.7, top:-13, justifyContent:'center',}}>
              ...
              {/* Button */}
              <View style={{flex: 1}}>
                <TouchableOpacity style={{paddingLeft:10}} onPress={() => this.props.navigation.navigate('SymptomsScreenDetail')}>
            ...
            <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{marginHorizontal: 10}}>
              <View style={{flexDirection:'row'}}>
                ...
                <View style={styles.subdetail}>
                    ...
                    <View style={styles.subimageblock}>
                      <Text style={{textAlign:'center', fontWeight:'bold', color: Color.primary, fontSize:12.5, marginBottom:10}}>Blood-Tinged Sputum</Text>
                    </View>
                </View>
              </View>
            </ScrollView>
