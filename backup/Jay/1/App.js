...
import {HomeScreen, HomeScreenDetail, MapsScreen, MapsScreenDetail, NewNormalScreen,
  NewNormalScreenDetail, InfoScreen, InfoScreenDetail, SymptomsScreenDetail} from './src/tab'
...
function HomeStack(){
  return(
    <StackHome.Navigator initialRouteName="Home">
      ...
      <StackHome.Screen name="SymptomsScreenDetail" component= {SymptomsScreenDetail} options={navOptionHandler}/>
    </StackHome.Navigator>
  );
}
